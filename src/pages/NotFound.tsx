...
const exploreLinkAccentColors = ["bg-sky", "bg-green", "bg-yellow", "bg-pink", "bg-orange"];
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          {exploreLinks.map((link, index) => {
            return (
              ...
              >
                <span
                  className={`absolute -right-8 -top-8 h-24 w-24 rounded-full ${exploreLinkAccentColors[index % exploreLinkAccentColors.length]} opacity-65 blur-2xl transition-transform group-hover:scale-110`}
                  aria-hidden
                />
